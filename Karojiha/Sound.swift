...
class Sound {
    ...
    */
    ...
    public let fly2Sound = SKAction.playSoundFileNamed("fly2a.wav", waitForCompletion: true)
    public let fly1Sound = SKAction.playSoundFileNamed("fly1a.wav", waitForCompletion: true)
